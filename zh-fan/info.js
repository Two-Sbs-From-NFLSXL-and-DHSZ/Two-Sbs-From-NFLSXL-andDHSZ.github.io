...
function translate_fan () 
{
	...
	ad.innerHTML  = "<div class = 'chn' > &nbsp;&nbsp;&nbsp;&nbsp; A-level考試是由AQA、OCR、Edexcel等考試局舉辦的分學科考試。作為GCE的一部分，A-level考試在英國被視為高中畢業考試以及大學入學考試。學生大多能在2年之內完成A-level科目的考試，其中每年完成3~4門科目考試。與其它考試不同，A-level沒有指定考試學科，所以學生可以自由選擇自己喜愛的科目考試。除英國外，新加坡、烏干達、肯尼亞也都有自己的A-level考試系統。 </div>" ;
	apt.innerHTML = "<div class = 'chn' > AP 考試 </div>" ;
	apd.innerHTML = "<div class = 'chn' > &nbsp;&nbsp;&nbsp;&nbsp;AP(美國大學預科課程)是College Board(美國大學理事會)設立的項目。AP主要為學有餘力的高中學生提供大學課程和考試，且考試成績可以兌換美國大學學分。AP考試在五月第一個星期一開始並持續兩個星期，其間30多門AP科目的考試將舉行。AP考試的分數在1~5之間，其中1為最低分，5為最高分。考生可以在七月得到AP考試分數，之後學生可以選擇取消自己不滿意的學科考試分數。	</div>" ;
	st.innerHTML = "<div class = 'chn' > SAT 考試 </div>" ;
	sd.innerHTML = "<div class = 'chn' > &nbsp;&nbsp;&nbsp;&nbsp; SAT考試是College Board舉辦的標準化考試。作為美國大學入學考試之一，SAT主要測試學生是否具備申請美國大學的能力。SAT考試主要分為閱讀、文法和數學，另有可以選考的作文。SAT通常在三、四、五、六、八、十、十二月進行，其中三、五、十、十二月在亞太地區設有考點。SAT考試需要3個小時完成，作文另有50分鐘。考生通常可以在考試結束後3個星期得到考試成績。</div>" ;
	actt.innerHTML = "<div class = 'chn' > ACT 考試 </div>" ;
	actd.innerHTML = "<div class = 'chn' > &nbsp;&nbsp;&nbsp;&nbsp; ACT考試是由非營利組織ACT舉辦的標準化考試。它主要測試學生在英語、數學、閱讀和科學方面的能力，每項單獨計分，總分36分。ACT考試在二、四、六、七、九、十、十二月設有考試。ACT考試時間為3個小時，但是其題量較SAT多，因此考生需要掌握在短時間內閱讀並答題的能力。 </div>" ;
