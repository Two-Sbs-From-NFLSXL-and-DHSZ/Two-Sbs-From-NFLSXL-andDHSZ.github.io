...
function translate_zh () 
{
	...
	ns.innerHTML = "日程" ;
	na.innerHTML = "关于" ;
	at.innerHTML = "<div class = 'chn' > 关于网站 </div>" ;
	ad.innerHTML = "<div class = 'chn' > &nbsp;&nbsp;&nbsp;&nbsp; 此网站是由苏州德威的zym和南外仙林的fjh拥有并设计的，本网站是基于GitHub Pages开发的。我们开发网站的主要目的是帮助国际高中学生在国际考试，如A-level，SAT和AP中能够取得理想的成绩。本网站的主要功能是线上搜题，我们可以帮助学生解决他们在国际考试的复习过程中所遇到的难题。我们也提供线上练习和线上实验功能来帮助他们取得更好的成绩。希望您能够享受浏览本网站。 </div>" ;
	adt.innerHTML = "<div class = 'chn' > 关于开发者 </div>" ;
	add.innerHTML = "<div class = 'chn' > 暂无内容 </div>" ;
	ct.innerHTML = "<div class = 'chn' > 联系我们 </div>" ;
	cd.innerHTML = "<div class = 'chn' > 暂无内容 </div>" ;
	ft.innerHTML = "语言：" ;
