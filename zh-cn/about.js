...
function translate_zh () 
{
	...
	na.innerHTML = "关于" ;
	at.innerHTML = "关于网站" ;
	ad.innerHTML = "&nbsp;&nbsp;&nbsp;&nbsp; 此网站是由苏州德威的zym和南外仙林的fjh拥有并设计的，本网站是基于GitHub Pages开发的。我们开发网站的主要目的是帮助国际高中学生在国际考试，如A-level，SAT和AP中能够取得理想的成绩。本网站的主要功能是线上搜题，我们可以帮助学生解决他们在国际考试的复习过程中所遇到的难题。我们也提供线上练习和线上实验功能来帮助他们取得更好的成绩。希望您能够享受浏览本网站。" ;
	adt.innerHTML = "关于开发者" ;
	add.innerHTML = "暂无内容" ;
	ct.innerHTML = "联系我们" ;
	cd.innerHTML = "暂无内容" ;
