...
function translate_zh () 
{
	...
	ns.innerHTML = "日程" ;
	na.innerHTML = "关于" ;
	ad.innerHTML  = "&nbsp;&nbsp;&nbsp;&nbsp;A-level考试是由AQA、OCR和Edexcel举办的分学科考试。作为GCE的一部分，A-level考试\
	在英国被视为高中毕业考试及大学入学考试。学生大多在2年内完成A-level的考试，其中每年完成3~4门科目的考试。与其它考试不同的是，A-\
	level考试没有指定科目，所以考生可以选择自己喜爱的科目完成考试。除英国外，新加坡、乌干达、肯尼亚等国家也都设立了自己的A-level考\
	试系统。" ;
	apt.innerHTML = "AP 考试" ;
	apd.innerHTML = "&nbsp;&nbsp;&nbsp;&nbsp;AP(美国大学预科课程)是College Board(美国大学理事会)设立的项目。AP主要为学有余力\
	的高中学生提供大学课程及考试，并且考试成绩可以兑换美国大学学分。AP考试在五月第一个星期一开始并持续两个星期，其间30多门AP考试将\
	会举办。AP考试的分数为1~5之间，其中1为最低，5为最高。AP考试成绩在七月公布，之后考生可以决定是否取消本次考试成绩。" ;
	st.innerHTML = "SAT 考试" ;
	sd.innerHTML = "&nbsp;&nbsp;&nbsp;&nbsp;SAT考试是College Board举办的标准化考试，作为两种美国大学入学考试之一，SAT考试测\
	试学生是否具备申请美国大学的能力。SAT考试分为阅读、语法和数学三部分，另有可以选考的写作。SAT通常在三、四、五、六、八、十、十二月举\
	行，其中三、五、十、十二月在亚太地区设有考点。但是由于中国大陆没有SAT考点，所以学生需要到港澳台进行考试。SAT考试需要3个小时完成，\
	作文另有50分钟。考生通常可以在考试结束之后3个星期内得到分数。" ;
	actt.innerHTML = "ACT 考试" ;
	actd.innerHTML = "&nbsp;&nbsp;&nbsp;&nbsp;ACT考试是由非营利组织ACT举办的标准化考试。它主要测试学生在英语、数学、阅读和科学\
	的能力，每项单独计分，总分为36分。ACT考试在二、四、六、七、九、十、十二月设有考试，但是中国大陆不设有考点。ACT考试时间为3个小时，\
	但是题量较SAT多，所以考生需要掌握在短时间内完成阅读和答题的能力。" ;
	lm1.innerHTML = "了解更多" ;
	lm2.innerHTML = "了解更多" ;
	lm3.innerHTML = "了解更多" ;
	lm4.innerHTML = "了解更多" ;
